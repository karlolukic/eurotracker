...
# Load data ------
inflation_data <- read_rds(here("data", "inflation_data.rds"))
m3_data <- read_rds(here("data", "m3_data.rds"))
gdp_data <- read_rds(here("data", "gdp_data.rds"))
unemployment_data <- read_rds(here("data", "unemployment_data.rds"))
usd_data <- read_rds(here("data", "usd_data.rds"))
gov_debt_data <- read_rds(here("data", "gov_debt_data.rds"))

euro_rate_data <- read_rds(here("data", "euro_rate_data.rds"))
gov_bond_yield_data <- read_rds(here("data", "gov_bond_yield_data.rds"))
loans_to_corp_data <- read_rds(here("data", "loans_to_corp_data.rds"))
loans_to_households_data <- read_rds(here("data", "loans_to_households_data.rds"))
cost_borrowing_house_data <- read_rds(here("data", "cost_borrowing_house_data.rds"))
cost_borrowing_corp_data <- read_rds(here("data", "cost_borrowing_corp_data.rds"))

current_account_data <- read_rds(here("data", "current_account_data.rds"))
direct_investment_data <- read_rds(here("data", "direct_investment_data.rds"))
portfolio_investment_data <- read_rds(here("data", "portfolio_investment_data.rds"))
real_effective_data <- read_rds(here("data", "real_effective_data.rds"))
reserve_assets_data <- read_rds(here("data", "reserve_assets_data.rds"))
nominal_effective_data <- read_rds(here("data", "nominal_effective_data.rds"))

total_assets_data <- read_rds(here("data", "total_assets_data.rds"))
non_perf_loans_data <- read_rds(here("data", "non_perf_loans_data.rds"))
significant_inst_data <- read_rds(here("data", "significant_inst_data.rds"))
return_on_equity_data <- read_rds(here("data", "return_on_equity_data.rds"))
cet1_ratio_data <- read_rds(here("data", "cet1_ratio_data.rds"))
liquidity_coverage_data <- read_rds(here("data", "liquidity_coverage_data.rds"))
